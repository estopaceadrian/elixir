defmodule PasswordGenerator do
  ...
  Than function takes the options map.any()
  Options example:
          options =%{
            "length" => "5",
            "numbers" => "true",
          ...
          The options are ony 4, `length`, `numbers` and `uppercase`, `symbols`.
  """
  ...
  defp validate_length(true, options) do
    ...
    validate_length_is_integer(length, numbers)
  end
  ...
  defp validate_length_is_integer(true, options) do
    ...
    defp validate_options_values_are_boolean(false, _length, _options) do
      {:error, "Only booleans allowed for options valies"}
    end
